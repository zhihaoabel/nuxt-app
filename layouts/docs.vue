...
const footerLinks = reactive({
    products: [
        { label: '支付处理', to: '/', external: false },
        { label: '收入管理', to: '/', external: false },
        { label: '平台市场', to: '/', external: false },
        { label: '资金管理', to: '/', external: false },
        { label: '开发工具', to: '/', external: false }
    ],
    resources: [
        { label: '文档中心', to: '/', external: false },
        { label: 'API 参考', to: '/', external: false },
        { label: '示例代码', to: '/', external: false },
        { label: '最佳实践', to: '/', external: false },
        { label: '更新日志', to: '/', external: false }
    ],
    support: [
        { label: '帮助中心', to: '/', external: false },
        { label: '联系我们', to: '/', external: false },
        { label: '社区论坛', to: 'https://community.example.com', external: true },
        { label: '状态页面', to: 'https://status.example.com', external: true },
        { label: '反馈建议', to: '/', external: false }
    ]
})
</script>
